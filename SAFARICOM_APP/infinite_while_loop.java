...
public class infinite_while_loop {
    ...
    static getMobileNum GET_MOBILE_NUM = new getMobileNum();

    static Scanner prompt_user = new Scanner(System.in);

    

    public void INFINITE_WHILE_LOOP (String[] USER_INFO, String[] AGENT_INFO) {
        ...
        while (true) {
            ...
            System.out.println("4. Check My Mobile Number.");
            ...
            switch (choice) {
               ...
               case 4:
                  System.out.println(GET_MOBILE_NUM.getNumber());
                  break; 
